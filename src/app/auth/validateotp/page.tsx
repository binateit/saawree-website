...
const ValidateOTPPage: FC<Props> = ({ userId, updateStep }) => {
  console.log(userId);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formValues, { setFieldError, setSubmitting }) => {
      ...
      try {
        ...
        let result: Result = await customerEmailConfirmation(emailData);
      ...
      <section className='login-page'>
        <div className='container'>
          ...
          <p className='text-center'>
            If you don't receive your access codes after 5 minutes then click on
            resend
          </p>
