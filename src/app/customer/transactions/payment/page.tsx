...
import { PaymentRecords } from "@/core/models/customerModel";
import { Filter, PaginationFilter } from "@/core/models/model";
import { FilterOption } from "@/core/models/saleOrderModel";
import { getPaymentListOfCustomer } from "@/core/requests/customerRoutes";
...
const page = () => {
  ...
  const {
    ...
    queryKey: ["payment-list", paginationModel, filterQuery],
    queryFn: () => {
      return getPaymentListOfCustomer({ ...filterQuery, ...paginationModel });
    },
  });
        ...
        <div className='card-body'>
          ...
          >
            ...
            <Column
              ...
              body={(rowData) => (
                <Link
                  href={`/customer/transactions/payment/details?paymentId=${rowData?.id}`}
                  className='btn btn-saawree'
                >
                  View
                </Link>
