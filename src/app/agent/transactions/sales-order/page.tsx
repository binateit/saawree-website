...
const Page = () => {
  ...
  const {
    ...
    queryKey: ["agent-sales-order-list", paginationModel, filterQuery],
    queryFn: () => {
      return getSaleOrdersOfAgent({ ...filterQuery, ...paginationModel });
    },
  });
      ...
      <div className='card mb-2'>
        <div className='card-header align-items-center justify-content-between bg-white'>
          ...
          {!isFilter ? (
            ...
            <BsChevronUp fontSize={20} onClick={() => setIsFilter(!isFilter)} />
          )}
        </div>
      ...
      <div className='card shadow'>
        <div className='card-header bg-white'>
          <div className='d-flex justify-content-between align-items-center w-100'>
            <h5>Sale Order</h5>
            <Link
              href='/agent/transactions/sales-order/add-sale-order'
        ...
        <div className='card-body'>
          ...
          >
            ...
            <Column
              ...
              body={(rowData) => (
                <Link
                  href={`/agent/transactions/sales-order/details?saleOrderId=${rowData?.id}`}
                  className='btn btn-saawree'
                >
                  View
                </Link>
