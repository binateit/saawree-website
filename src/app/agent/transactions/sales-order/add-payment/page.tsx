        ...
        <div className='card-body'>
          <div className='row'>
            <div className='col-xl-4 col-lg-6 col-md-6 col-sm-12'>
              ...
              <p className='mb-2'>
                B107, Sai Sanman CHSL, Guru Nanak Nagar, Vasai, Maharashtra
                401202 India <small>(Shipping Address)</small>
              </p>
          ...
          <form className='account-dtls'>
            <div className='form-group'>
              <div className='row'>
                ...
                <div className='col-xl-6 col-lg-6 col-md-6 mb-3'>
                  ...
                  <div className='d-flex flex-wrap'>
                    <div className='payment-option mr-3'>
                      <input type='radio' name='payment' value='bhim-upi' />{" "}
                      BHIM UPI
                    </div>
                    <div className='payment-option mr-3'>
                      <input type='radio' name='payment' value='bhim-upi' />{" "}
                    ...
                    <div className='payment-option mr-3'>
                      <input type='radio' name='payment' value='bhim-upi' /> Net
                      Banking
                    </div>
                    <div className='payment-option mr-3'>
                      <input type='radio' name='payment' value='bhim-upi' />{" "}
                ...
                <div className='col-xl-6 col-lg-6 col-md-6 mb-3'>
                  <label htmlFor=''>
                    Cheque Bank Name<span className='required'>*</span>
                  </label>
                  <input type='text' className='form-control' id='' />
                </div>
                <div className='col-xl-6 col-lg-6 col-md-6 mb-3'>
